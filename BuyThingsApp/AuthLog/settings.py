...
INSTALLED_APPS = [
    ...
    'eCommerce.apps.ECommerceConfig', # Your custom app for eCommerce, configured to set up groups automatically
]
...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'Cyber!King?1199',         # Your database password
...
EMAIL_HOST_USER = os.environ.get('EMAIL_HOST_USER')           # Replace with your email host
