...
- [Repo Link](#implementing-the-project)
- [Running the Project](#implementing-the-project)
...
```
The host server and password for the email backend is nto committed to git for the protection of my personal data.
In order for the project to run, the EMAIL_HOST_USER and EMAIL_HOST_PASSWORD with your desired credentials
or create your own .env file containing those credential at the project root that the settings file with discover and import.
```
